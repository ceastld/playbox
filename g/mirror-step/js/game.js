  ...
  function showClear() {
    if (S.stage >= STAGES.length - 1) {
      ...
      showOverlay({
        kicker: "MIRROR STEP",
        title: "镜面尽头",
        msg: "二十次落脚，一次也没有踏空。<br />你与镜中的你始终同步。",
        help: "",
