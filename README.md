...
一百二十一个小游戏。每个游戏一个目录，互不重编。大厅默认看精选，按复刻 / 节奏 / 水面 / 巧思 / 动作 / 养成筛，也能搜。

现在在写经典复刻，质量优先，手感要爽，不堆新原创。已上架：2048、贪吃蛇、扫雷、俄罗斯方块、2048·五、门蛇、破砖、蜂雷、四十行、箱迷、墙乒、翻碟、斩果、叠崩、弹珠、星袭、连环、蛙路、噬潮、三消、气球。
